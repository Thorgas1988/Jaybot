...
public class YoloState {
	...
	public void advance(ACTIONS action) {
		...
		this._advancedActions.add(action);
		clear();
	...
	public YoloState copy() {
		return new YoloState(_stateObservation.copy(), new ArrayList<>(_advancedActions));
	}
	...
	public ArrayList<ACTIONS> getValidActions(boolean ignoreStochasticEnemyKilling) {
		return getValidActions(ignoreStochasticEnemyKilling, true);
	}

	public ArrayList<ACTIONS> getValidActions(
			boolean ignoreStochasticEnemyKilling, boolean includeNil) {
